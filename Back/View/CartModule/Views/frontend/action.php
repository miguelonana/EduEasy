<?php
	...
	if (isset($_POST['pid'])) {
	  ...
	  if (!$code) {
	    ...
	    echo '<div class="alert alert-success alert-dismissible mt-2">
						  ...
						  <strong>Cours ajouté à votre panier!</strong>
						</div>';
	  } else {
	    echo '<div class="alert alert-danger alert-dismissible mt-2">
						  <button type="button" class="close" data-dismiss="alert">&times;</button>
						  <strong>Cours déjà ajouté à votre panier!</strong>
						</div>';
	  }
	}
	...
	if (isset($_GET['remove'])) {
	  ...
	  $_SESSION['message'] = 'Cours retiré du panier!';
	...
	if (isset($_GET['clear'])) {
	  ...
	  $stmt->execute();
	  $_SESSION['showAlert'] = 'block';
	  $_SESSION['message'] = 'Tous les Cours ont été supprimés du panier!';
	  header('location:cart.php');
	}
	...
	$idclient =3;
	  ...
	  $data .= '<div class="text-center">
								...
								<h4 class="text-secondary">Votre achat du cours a été passée avec succès <i class="fas fa-check-circle"></i></h4>
								<h4 style="background-color:tomato; text-white">Cours achetés : ' . $products . '</h4>
								</br>
