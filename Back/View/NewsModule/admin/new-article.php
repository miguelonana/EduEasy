...
<head>
    ...
    <link rel="stylesheet"
        href="cpanel/vendors/bower_components/bootstrap3-wysihtml5-bower/dist/bootstrap3-wysihtml5.css" />
    <link href="cpanel/vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.min.css" rel="stylesheet"
        type="text/css" />
    <link href="cpanel/vendors/bower_components/bootstrap-tagsinput/dist/bootstrap-tagsinput.css" rel="stylesheet"
        type="text/css" />
</head>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="mobile-only-brand pull-left">
                <div class="nav-header pull-left">
                    <div class="logo-wrap">
                        <a href="./">
                            <img class="brand-img inner_logo" src="images/logos/<?php echo WBLogoInverse; ?>"
                                alt="brand" />
                        </a>
                    </div>
                </div>
                <a id="toggle_nav_btn" class="toggle-left-nav-btn inline-block ml-20 pull-left"
                    href="javascript:void(0);"><i class="dripicons-menu"></i></a>
                        ...
                        <div class="panel panel-default card-view">
                            ...
                            <div class="panel-wrapper collapse in">
                                ...
                                <div class="panel-body">
                                    <div class="form-wrap">
                                        <form id="app_frm" action="admin/core/new_blog_post" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input placeholder="Enter post title" type="text"
                                                        class="form-control txt-cap" name="title" required>
                                                </div>
                                            </div>
                            ...
                            ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea id="short_description" name="description"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="content" class="textarea_editor form-control"
                                                        rows="15" required placeholder="Enter content ..."></textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="fileinput fileinput-new input-group"
                                                        ...
                                                        <div class="form-control" data-trigger="fileinput"> <i
                                                                class="feather icon-image fileinput-exists"></i> <span
                                                                class="fileinput-filename"></span></div>
                                                        <span
                                                            class="input-group-addon fileupload btn btn-info btn-anim btn-file"><i
                                                                class="feather icon-upload"></i> <span
                                                            ...
                                                            data-dismiss="fileinput"><i
                                                                class="feather icon-trash-2"></i><span class="btn-text">
                                                                Remove</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input
                                                        ...
                                                        type="text" class="form-control" name="y_video">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input name="tags" required type="text" class="form-control"
                                            ...
                                            <div class="form-group mb-0">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <button type="submit" id="article_btn" name="submit"
                                                        class="btn btn-danger"><span class="btn-text">Publish
                                                            Article</span></button>
                                                </div>
                                            </div>
                                        </form>
