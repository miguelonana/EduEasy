      ...
      <div class="row">
        <div class="col-md-12">
          <div class="footer-info-content">
            ...
            <p></p>
            <p class="footer-info-phone"><i class="feather icon-phone-call"></i> +2165285125499</p>
            <p class="footer-info-email"><i class="feather icon-mail"></i> EduEasyNews@username.com</p>
