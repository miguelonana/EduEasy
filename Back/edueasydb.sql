...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 06 jan. 2022 à 03:53
...
(1, '2021STU0', 'ONANA Miguel Stephane', 3, 'C\'est tableau associatif utilisable pour la gestion de session en php');
...
(125, 'Offre svt', '90', 'basson.jpg', 4, '360', ''),
(126, 'Offre Chimie', '200', 'aa.jpg', 2, '400', ''),
(127, 'Offre Gold', '39', 'hot.jpg', 1, '39', ''),
(128, 'Offre Chimie', '200', 'aa.jpg', 1, '200', '');
...
(12, 'Chapter 1', 'Introduction', 14, 'images/CourseElements/HTML5.pdf'),
(13, 'Chapter 2', 'In this chapter we are going to learn about PHP language', 14, 'images/CourseElements/PHP - part 1.pdf'),
(14, 'Chapter 3', 'Chapter 3', 14, 'images/CourseElements/PHP - part 2.pdf'),
(15, 'Chapter 4', 'Chapter 4', 14, 'images/CourseElements/PHP - part 2.pdf');
...
(14, 'Projet Web', 'Computer Science', '2021TEA2', 'esprit_logo.jpg', 1, 'esprit_logo.jpg', 6, 3),
(15, 'Maths 1', 'Mathematics', '2021TEA2', 'favicon.png', 0, 'favicon.png', 0, 0),
(16, 'Accounting', 'Business and Mangement', '2021TEA2', 'ESB.png', 1, 'ESB.png', 0, 0);
...
--
-- Déchargement des données de la table `followcourse`
--

INSERT INTO `followcourse` (`userId`, `courseId`) VALUES
('2021STU3', 14);
...
(4, 'registration', 'New User Registration.  student, bristow with User Id: 2021STU1 has registered to EduEasy.', '2021-12-14 08:38:03', 'read'),
(5, 'registration', 'New User Registration.  student, miguel with User Id: 2021STU2 has registered to EduEasy.', '2021-12-14 13:51:00', 'read'),
(6, 'registration', 'New User Registration.  teacher, Mr Nader with User Id: 2021TEA2 has registered to EduEasy.', '2021-12-14 16:04:38', 'read'),
(10, 'registration', 'New User Registration.  student, Stephane Miguel ONANA with User Id: 2021STU3 has registered to EduEasy.', '2021-12-15 16:56:49', 'read'),
(11, 'registration', 'New User Registration.  student, Stephane Miguel ONANA with User Id: 2021STU3 has registered to EduEasy.', '2021-12-15 17:00:42', 'read'),
(12, 'registration', 'New User Registration.  student, Stephane Miguel ONANA with User Id: 2021STU3 has registered to EduEasy.', '2021-12-15 17:08:13', 'unread'),
(13, 'registration', 'New User Registration.  student, Stephane Miguel ONANA with User Id: 2021STU3 has registered to EduEasy.', '2021-12-15 17:24:20', 'unread');
...
(1, 'comment uploader un fichier en php?', 'je n\'arrive pas a uploader le fichier de mon formulaire . je recois l\'erreur &quot;$_FILES[\'file\'][\'tmp_name\'] undefined&quot;.', 'move_uploaded_file($_FILES[\'file\'][\'tmp_name\'], &quot;../View/images/CourseElements/&quot;.basename($_FILES[&quot;file&quot;][&quot;tmp_name&quot;]));', 2021, 'ONANA Miguel Stephane', '15/12/2021'),
(3, 'comment s\'utilise la variable $_SESSSION svp?', 'je souhaite faire une gestion de session sur mon site.', 'jaimerais savoir comment fonctionne $_SESSION et comment je dois m\'en servir ', 2021, 'ONANA Miguel Stephane', '15/12/2021'),
(4, 'a quoi sers la balise &lt;i&gt;&lt;/i&gt; en html svp?', 'je ne comprend pas a quoi sers &lt;i&gt;&lt;/i&gt;', 'jaimerais savoir a quoi sers et comment l\'utiliser &lt;i&gt;&lt;/i&gt;', 2021, 'bristow', '15/12/2021'),
(5, 'comment s\'utilise la variable $_SESSSION svp?', 'comment s\'utilise la variable $_SESSSION svp?', 'comment s\'utilise la variable $_SESSSION svp?', 2021, 'Stephane Miguel ONANA', '15/12/2021'),
(6, 'test question', 'test question', 'test question', 2021, 'Stephane Miguel ONANA', '15/12/2021');
...
(55, 'yyvsudiv', 'sdvdsv', 'svsvdsvsd@hjavc.csio', 0, '2021-12-14', 9119),
(56, 'egeghrh', 'rghrtg', 'miguelstephane.onana@esprit.tn', 0, '2021-12-14', 95132),
(57, 'eee', 'eeee', 'eeeeee@dfhd.fgh', 1, '2021-12-14', 6807),
(58, 'onana', 'miguel', 'arwa.ali@esprit.tn', 0, '2021-12-14', 74289),
(59, 'ddd', 'dddd', 'miguelstephane.onana@esprit.tn', 3, '2021-12-14', 4060),
(60, 'jjijiuj', 'hjbguy', 'miguelstephane.onana@esprit.tn', 0, '2021-12-14', 8992),
(61, 'dsfvdfsv', 'ergerf', 'mi@gmail.com', 1, '2021-12-14', 6570),
(62, 'Chapter', '1', 'nader.abdellaoui@esprit.tn', 0, '2021-12-15', 3937);
...
('2021STU1', 'bristow', 'bristowtresor.djuipouguepi@esprit.tn', '$2y$10$KCqtWJD.Yyv4AwIkn.C4tONVro.OLGxSuzOKgebt8OUbXhYli5sCm', '2021-12-14', 0),
('2021STU2', 'miguel', 'nour.hassine@esprit.tn', '$2y$10$I.3ff954NfewXBH.I5m06.KGO1OJqYheEaR/FFzHYRHYqsc2VfnP6', '2021-12-14', 0),
('2021STU3', 'Stephane Miguel ONANA', 'miguelstephane.onana@esprit.tn', '$2y$10$aaVeNMSuTD6KTbkepFY6H.MBUxkCpVEp9SMOWvGPtvWrEte50WF5a', '2021-12-15', 0);
...
(3, 'COP26: UK \'nowhere Near\' Meeting Targets Agreed At Glasgow Climate Summit', 'December 13, 2021', '6', 1, 'science/img.png', '<div>The Climate Change Committee (CCC) says that, at current rates, the UK will be contributing to a disastrous temperature rise of 2.7C by 2100.</div><div><br></div><div>It says this could - in theory - be brought down to just under 2C.</div><div><br></div><div>But this could only happen if ministers agree tougher policies, and if other nations slash emissions too.</div><div><br></div><div>The government insists that it will meet all its climate change targets.</div><div><br></div><div>New global climate deal struck in Glasgow</div><div>Evasive words, but deal shows progress</div><div>How will decisions made at COP26 affect our lives?</div><div>Scientists say any temperature rise approaching 2C is extremely dangerous, so green groups want the UK to improve its emissions targets.</div><div><br></div><div>But the CCC says Britain will set a better example to the world if it keeps the same targets but actually delivers them through stronger policies.</div><div><br></div><div>It maintains that the government must nudge people towards greener lifestyles, and must tackle emissions from farming more aggressively.</div><div><br></div><div>The committee\'s chief executive, Chris Stark, said: \"The government is nowhere near achieving current targets.</div>', 'The UK is \"nowhere near\" meeting emissions targets enshrined at the Glasgow climate summit, official advisers have warned', '', 'science', 1),
(4, 'Climate Change: Is ?blue Hydrogen’ Japan’s Answer To Coal?', 'December 13, 2021', '6', 1, 'science/img.png', '<div>But today Saiki-San is angry.</div><div><br></div><div>\"It\'s a total joke,\" he says, in perfect English. \"Just ridiculous!\"</div><div><br></div><div>The cause of his distress is a giant construction site blocking our view across the bay - a 1.3-gigawatt coal-fired power station in the making.</div><div><br></div><div>\"I don\'t understand why we still have to burn coal to generate electricity,\" says Saiki-San\'s friend, Rikuro Suzuki. \"This plant alone will emit more than seven million tonnes of carbon dioxide every year!\"</div><div><br></div><div>Suzuki-San\'s point is a good one. Shouldn\'t Japan be cutting its coal consumption, not increasing it, at a time of great concern about coal\'s impact on the climate?</div><div>So why the coal? The answer is the 2011 Fukushima nuclear disaster.</div><div><br></div><div>In 2010 about one third of Japan\'s electricity came from nuclear power, and there were plans to build a lot more. But then the 2011 disaster hit, and all Japan\'s nuclear power plants were shut down. Ten years later most remain closed - and there is a lot of resistance to restarting them.</div><div><br></div><div>In their place Japan\'s gas-fired power stations have been doing a lot of overtime. But, as Britain has found out recently, natural gas is expensive.</div><div>So, the Japanese government decided to build 22 new coal-fired power stations, to run on cheap coal imported from Australia. Economically it made sense. Environmentally, not so much. Japan is now under intense pressure to stop using coal.</div><div><br></div><div>Instead of closing the old coal plants and switching to renewables, Japan\'s answer is to switch to burning hydrogen or ammonia.</div><div><br></div><div>\"The investment made by electric power companies in coal-fired power plants would suddenly be useless without value in their balance sheet,\" says Prof Tomas Kaberger, an expert on energy policy at Chalmers University in Sweden.</div><div><br></div><div>\"And it would create financial difficulties for electric power companies and then for banks and pension funds. And that is the challenge for Japan.\"</div><div><br></div><div>The plants can be quite easily converted to burning hydrogen or ammonia, neither of which produce any carbon dioxide. So this seems like a good solution.</div><div><br></div><div>But Japan\'s government has much bigger ambitions than that. It wants to be the world\'s first \"hydrogen economy\".</div><div><br></div><div>This is where the carmaker Toyota comes in.</div>', 'It\'s a glorious autumn afternoon and I\'m standing on a hillside looking out over Tokyo Bay. Beside me is Takao Saiki, a usually mild-mannered gentleman in his 70s', '', 'science', 1),
(5, 'Students Take Over Their Classrooms To Demand Teaching On Climate Change', 'December 13, 2021', '4', 1, 'education/img.png', '<div>Students have become the teachers in a global lesson takeover, designed to highlight the importance of climate education.</div><div><br></div><div>Across 20 countries, pupils have replaced their teachers today to lead lessons with up-to-date climate science in an effort to focus more on the lack of climate awareness in schools.</div><div><br></div><div>‘Teach the Teacher’, a student-led campaign, is being initiated by climate organisations SOS-UK, Mock COP26, EARTHDAY.ORG and Educational International.</div><div><br></div><div>The campaign calls for climate education to be “integrated, mandatory and assessed throughout the education system, by embedding it in education policy and teacher training across the globe”. </div>', 'A global campaign has students taking over from teachers to bring climate change issues to the front of the class', '', 'education', 1),
(6, '?I Was Always Curious’: Indian Woman, 104, Fulfils Dream Of Learning To Read', 'December 13, 2021', '4', 0, 'education/img.png', '<div>For almost a century, Kuttiyamma’s daily routine had been much the same. Rising early at home in the village of Thiruvanchoor in Kerala, the 104-year-old would begin her day’s work of cooking, cleaning and feeding the cows and chickens.</div><div><br></div><div>But now, every morning, there’s something new to get up for. She eagerly awaits the paperboy to deliver Malayala Manorama, the local newspaper.</div><div><br></div><div>For two hours, she buries herself reading the news and keeping herself informed about what’s going on in the world. But it is only in recent months that she has been able to fulfil this dream of hers – in April, Kuttiyamma finally began to learn to read.</div><div><br></div><div>“I was always curious about what was happening around the world,” she said. “On many occasions I regretted my inability to read newspapers and I used to plead with the younger generations at home to read out newspapers to me. I always wanted to write my name and address.”</div><div><br></div><div>After months of evening classes, she decided to take the Kerala state primary literacy exam last month, the oldest woman to do so. She achieved 89% in literacy and 100% in mathematics. It was a result that drew praise from the state education minister, who tweeted: “Age is no barrier for knowledge. With utmost respect and love, I wish Kuttiyamma and all other new learners the best.”</div>', 'Daily newspaper is new joy for Kuttiyamma, who began taking lessons from her neighbour a year ago\r\nPublished', '', 'education', 1),
(7, 'Covid-19 : Que Sait-on Du Variant Omicron ?', 'December 13, 2021', '5', 0, 'covid-19/img.png', '<div>Officiellement signalé en Afrique du Sud le 24 novembre, le nouveau variant Omicron est désormais présent sur tous les continents. Des cas ont été signalés dans 57 pays, selon l\'Organisation mondiale de la Santé. En Europe, il a été identifié dans 19 pays, selon les derniers chiffres. Plusieurs d\'entre eux, dont la France, ont déjà pris des mesures pour tenter de limiter sa propagation sur leur territoire.</div><div><br></div><div>Une première image tridimensionnelle de ce nouveau variant, réalisée et publiée le 27 novembre par l\'hôpital Bambino Gesù de Rome, montre qu\'il comporte notamment une trentaine de mutations dans la protéine \"spike\", clé d\'entrée du virus dans l\'organisme. Ce nombre, bien supérieur à celui du variant Delta, a suscité l\'inquiétude de l\'OMS, qui l\'avait qualifié de “préoccupant” fin novembre. </div>', 'La nouvelle souche de Covid-19 Omicron suscite l’inquiétude dans le monde depuis sa découverte. Si l’incertitude persiste autour de sa virulence, les scientifiques de l’OMS se sont voulus rassurants mardi, affirmant qu’il n’y avait \"aucune raison de douter\" de l’efficacité des vaccins.', '', 'covid-19', 1),
(8, 'Covid-19 : L\'Europe Appelée à Protéger Les Enfants Et à éviter La Vaccination Obligatoire', 'December 13, 2021', '5', 0, 'covid-19/img.png', '<div>En pleine flambée de Covid-19 en Europe, l\'OMS a appelé, mardi 7 décembre, à mieux protéger les enfants, actuellement la classe d\'âge la plus touchée, tout en gardant la vaccination obligatoire de la population comme une option de \"dernier ressort absolu\".</div><div><br></div><div>Sur le Vieux continent, où l\'OMS a dit redouter 500 000 morts supplémentaires d\'ici au printemps, plus de 120 000 personnes sont mortes du Covid-19 depuis cet avertissement lancé le mois dernier.</div><div><br></div><div>À l\'approche des fêtes de fin d\'année, synonymes de retrouvailles familiales et de nombreux voyages, le bilan évolue actuellement à un \"plateau élevé\" de plus de 4 000 morts par jour, selon l\'organisation</div>', 'À contre-courant de certaines décisions prises par plusieurs États, l\'Organisation mondiale de la santé (OMS) a lancé un appel mardi pour mieux protéger les enfants de la pandémie de Covid-19 et ne pas recourir à la vaccination obligatoire, susceptible d\'entraîner de possibles effets pervers sur la \"confiance du grand public\"', '', 'covid-19', 1),
(9, 'Flaw Prompts 100 Hack Attacks A Minute, Security Company Says', 'December 13, 2021', '7', 1, 'technology/img.png', '<div>Check Point said it had seen attempts to exploit the vulnerability on over 40% of corporate networks globally.</div><div><br></div><div>One US official said the security flaw, Log4shell, posed a \"severe risk\", with companies warning it was being actively used by criminal groups.</div><div><br></div><div>Fixes have been issued but need to be implemented. Popular applications and cloud services have been affected.</div><div><br></div><div>\'Specific address\'</div><div>Written in the programming language Java, Log4J, the code containing the flaw, is used by millions of computers running online services.</div><div><br></div><div>In the last four months it had been downloaded 84 million times from the largest public repository of open-source Java components, Brian Fox of security company Sonatype, said.</div><div>And the ease with which hackers could exploit the vulnerability was, \"akin to someone figuring out that mailing a letter into your postbox, with a specific address written on it, allows them to open all your doors in your house\"</div>', 'A flaw in widely used computer code is prompting 100 new hacking attempts every minute, a security company says', '', 'technology', 1),
(10, 'The Technology Helping Keep Women Safe On The Streets', 'December 13, 2021', '7', 1, 'technology/img.png', '<div>They might call a friend, share their location on WhatsApp, or have their keys to hand - all strategies to stay secure.</div><div><br></div><div>Sexual harassment against females has been under the spotlight for most of this year, with women across the UK turning to their own methods to feel better when they are out at night.</div><div><br></div><div>So could technology play a role in making women feel safer on our streets?</div><div>Since the murders of Sarah Everard and Sabina Nessa, the WalkSafe app has had a surge in popularity, and is now the fastest-growing safety app in the UK.</div><div><br></div><div>Founder Emma Kaye came up with the concept after experiencing harassment, groping and flashing.</div><div><br></div><div>\"Our app is really bitter-sweet because, of course, we love that we\'re busy. However, we really wish it didn\'t have to exist. No-one wants to live in a world where we need a safety app, but sadly there is a place for it,\" she said.</div><div><br></div><div>WalkSafe will have a new sat-nav feature coming early next year, which will include a live map where your family and friends will be able to track your journey and chat with you in real time. For now its unique selling point is a map which allows people to plan their safest route home, by looking at recent crime data.</div><div><br></div><div>Ms Kaye said: \"Our app encourages people to have precautionary measures to avoid crime, rather than reactionary measures when in an unfortunate situation.</div><div><br></div><div>\"We have senior ex-Metropolitan Police detectives and crime analysts comb through this data, and categorise it into areas the user would want to know about. By looking at the crime patterns, users can identify crime hotspots so they can plan safer routes.\"</div><div><br></div><div>Since launching in March this year, the app has had more than 560,000 downloads</div>', 'Half of all women have felt unsafe at some point walking alone in the dark, according to recent figures from the Office for National Statistics', '', 'technology', 1);
...
(3, '3', '2021-12-13', 'N/A', 'N/A', '::1', 'N/A'),
(4, '5', '2021-12-13', 'N/A', 'N/A', '::1', 'N/A'),
(5, '10', '2021-12-13', 'N/A', 'N/A', '::1', 'N/A'),
(6, '9', '2021-12-13', 'N/A', 'N/A', '::1', 'N/A'),
(7, '4', '2021-12-13', 'N/A', 'N/A', '::1', 'N/A');
...
(4, 'Education', '13 December 2021 09:20:17 PM', 'Active'),
(5, 'Covid-19', '13 December 2021 10:19:39 PM', 'Active'),
(6, 'Science', '13 December 2021 10:19:52 PM', 'Active'),
(7, 'Technology', '13 December 2021 10:20:25 PM', 'Active');
...
('2021TEA2', 'Mr Nader', 'nader.abdellaoui@esprit.tn', '$2y$10$17Jxas/ZI6Z1mwo5HaO7sOyZecIE/rZw4zdv.pP8yuU7NYJh70Cd6', '2021-12-14', 0);

-- --------------------------------------------------------

--
-- Structure de la table `userp`
--
...
--
ALTER TABLE `chapter`
  ADD CONSTRAINT `fk_courses_chapter` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `courses`
--
ALTER TABLE `courses`
  ADD CONSTRAINT `fk_courses_teacher` FOREIGN KEY (`teacher`) REFERENCES `teacher` (`userId`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `likecourse`
  ADD CONSTRAINT `fk_likecourse_courses` FOREIGN KEY (`courseId`) REFERENCES `courses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_likecourse_student` FOREIGN KEY (`userId`) REFERENCES `student` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE;
