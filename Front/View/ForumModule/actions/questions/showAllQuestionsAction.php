...
if(isset($_GET['search']) AND !empty($_GET['search'])){
    ...
    $getAllQuestions = $bdd->query('SELECT id, id_auteur, titre, description, pseudo_auteur, date_publication FROM question WHERE titre LIKE "%'.$usersSearch.'%" ORDER BY id DESC');
